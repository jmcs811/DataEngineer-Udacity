...
os.environ['AWS_ACCESS_KEY_ID']=config['AWS_INFO']['AWS_ACCESS_KEY_ID']
os.environ['AWS_SECRET_ACCESS_KEY']=config['AWS_INFO']['AWS_SECRET_ACCESS_KEY']
...
def main():
    ...
    output_data = "s3://datalake-spark-project/output/"
