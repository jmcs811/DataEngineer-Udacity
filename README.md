...
**[Project 3 - Spark](project3-DataLakes)**| Reading and transforming data from AWS S3 with Spark to parse them in partitioned parquet files | 
**[Project 4 - Airflow Pipelines](project4-Datapipelines-AirFlow)**| Building an Airflow Pipeline to automate parsing and transforming files from AWS S3 to AWS Redshift | 
