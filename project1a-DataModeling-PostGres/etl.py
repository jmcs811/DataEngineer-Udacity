...
def process_song_file(cur, filepath):
    '''
    This function parses song and artist info from json files, saving
    them into songs and artists tables
    Arugments:
        cur: Database cursor
...
def process_log_file(cur, filepath):
    '''
    This function parses time, user and songplay data, saving them
    into time, user, and songplay tables
    Arugments:
        cur: Database cursor
        filepath: the location of the json file
    Return: None
